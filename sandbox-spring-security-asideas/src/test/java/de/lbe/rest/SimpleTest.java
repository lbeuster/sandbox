...
import net.dontdrinkandroot.example.angularrestspringsecurity.rest.TokenTransfer;
import net.dontdrinkandroot.example.angularrestspringsecurity.rest.UserTransfer;
...
public class SimpleTest extends AbstractJUnit4Test {
	...
	public void testInvalidMethodSecurity() {
		...
		this.client.path("/rest/main/service2/param").header("X-Auth-Token", token).get().assertIsStatusUnauthorized();
	}
