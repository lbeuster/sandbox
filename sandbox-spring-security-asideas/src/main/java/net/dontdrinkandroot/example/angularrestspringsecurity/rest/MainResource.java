...
import net.dontdrinkandroot.example.angularrestspringsecurity.domain.AuthenticationService;
import net.dontdrinkandroot.example.angularrestspringsecurity.domain.SessionRepository;
import net.dontdrinkandroot.example.angularrestspringsecurity.domain.TestApplicationService;
import net.dontdrinkandroot.example.angularrestspringsecurity.security.UserDetailsAuthentication;
