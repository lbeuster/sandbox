...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@PostConstruct
	public void init() {
		this.authFilter = new AuthenticationTokenProcessingFilter(sessionRepository);
		this.authenticationProvider = new XAuthTokenAuthenticationProvider(this.sessionRepository, this.userRepository);
	}
